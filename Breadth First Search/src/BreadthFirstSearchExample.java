...
/**
 * Created by mosaic on 2017/08/04.
 * Anyone using this code agrees to consult
 * the owner Sontaga Moses Maluleke before use
 */
public class BreadthFirstSearchExample {
    ...
    public static void main(String arg[]){
        ...
        bfsExample.bfs(adjacency_matrix, node20);
        print(adjacency_matrix);
    }
    private static void print(int[][] adjacency_matrix){
